...
To model \textit{mud} mutant lineages, we impose a threshold at \(\pm 45^\circ\) such that any sampled rotation of the division plane exceeding \(45^\circ\) in magnitude is converted into a deterministic symmetric division along the neuroblast apical axis.
In the mutant rule set used here, this yields approximately 13\% symmetric divisions, consistent with experimental observation.
